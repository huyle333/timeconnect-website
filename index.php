...
<html lang = "en">
	...
	<body data-spy="scroll" data-target="#navigation" id="home">
	    ...
	    <div id="myCarousel" class="carousel slide" data-ride="carousel">
	      <div class="carousel-inner">
	        <div class="item active">
	          <img src="img/AssPNa3.jpg" alt="TimeConnect">
	          <div class="container">
	            <div class="carousel-caption">
	              <h1 style="background-color:rgba(75,75,75,0.7); padding: 10px; border-radius: 10px">The end of manual time cards.</h1>
	              <br>
	              <p><a class="btn btn-lg btn-primary" href="#" role="button">2-Minute Overview</a> &nbsp; <a class="btn btn-lg btn-primary" href="#" role="button">30-Day Free Trial</a></p>
	              <br>
	              <p>See why others choose TimeConnect</p>
	            </div>
	          </div>
	        </div>
	      </div>
		...
		<div class = "container marketing" style ="margin-top:-50px">
			...
			<br>
			<p style="text-align:center; color: #ADADAD">Check-in or out from work without any hassle. No more paper time cards. <br>It's an automated time card system that's simple, smart, and accurate.</p>
			<br>
		</div>

		<div class="jumbotron" style="background-color: #44aefc">
      		<div class="container text-center">
      			<h2 style="color: white"></h2>
      		</div>
    	</div>

    	<div class="jumbotron" style="background-color: #1eb5ea; margin-top: -30px">

      		<div class="container text-center">
      			<img style="margin: auto" class = "thumbnail" src = "img/timeclock_logo_white_small.png" height ="100px">
      			</br>
		...
		<div id = "end" class = "navbar navbar-default" style="height: 250px">
            <div class = "container">
            	...
            	<a href = "#" class = "navbar-btn btn-primary btn pull-right">Back to top</a>
                <p class = "navbar-text pull-left">&copy; 2014 - TimeConnect. All rights reserved.</p>
            </div>
      	</div>
